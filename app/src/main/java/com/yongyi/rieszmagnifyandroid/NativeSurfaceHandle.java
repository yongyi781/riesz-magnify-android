...
public class NativeSurfaceHandle implements AutoCloseable {
    ...
    /**
     * Lock a Surface that's been properly configured with {@link SurfaceHolder#setFixedSize(int, int)} and
     * {@link SurfaceHolder#setFormat(int)}. The format must be YV12.
     *
